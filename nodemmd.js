...
tests = [
  ...
  {'name': 'bold', 'input': '**bold** text', 'output': '<strong>bold</strong> text'},
  {'name': 'italic', 'input': '*italic* test', 'output': '<i>italic</i> test'},
  {'name': 'bold+italic+code', 'input': '*italic and **bold** text* `code`', 'output': '<i>italic and <strong>bold</strong> text</i> <code>code</code>'},
